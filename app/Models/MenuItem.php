...
class MenuItem extends Model
{
    ...
    public function category(){return $this->belongsTo(Category::class);} public function branches(){return $this->belongsToMany(Branch::class,'branch_menu_item')->withPivot(['is_available','price_override'])->withTimestamps();}
}
